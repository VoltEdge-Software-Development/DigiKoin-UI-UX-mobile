...
const BuySell: React.FC<BuySellProps> = ({ setIsLoggedIn, userType }) => {
  ...
  return (
    <View className="flex-1 bg-gray-200/85">
      <View className="flex-1 mt-[70px] p-5">
        {/* Tab Buttons */}
        ...
        {activeTab === 'buy' && (
          <View className="p-5 bg-white/10 rounded-[10px] shadow-sm">
            ...
            <TextInput
              className="border border-gray-300 p-2 rounded-md mb-4 text-[#454545] bg-white/80"
              placeholder="Amount"
              value={buyAmount}
