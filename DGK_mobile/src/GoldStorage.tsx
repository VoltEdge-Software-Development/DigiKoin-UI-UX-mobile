      ...
      <View className="flex-col gap-5">
        ...
        <View className="p-5 bg-white/10 rounded-[10px] shadow-sm">
          ...
          <View className="flex-col gap-2">
            <Text className="text-lg text-[#454545]">
              <Text className="font-bold">Ore Weight Processed:</Text> {metrics?.oreProcessed ?? 'Loading...'}
            </Text>
            <Text className="text-lg text-[#454545]">
            ...
            <Text className="text-lg text-[#454545]">
              <Text className="font-bold">Processing Efficiency:</Text> {metrics?.processingEfficiency ?? 'Loading...'}
            </Text>
          </View>
        ...
        <View className="p-5 bg-white/10 rounded-[10px] shadow-sm">
          ...
          <View className="flex-col gap-2">
            ...
            <Text className="text-lg text-[#454545]">
              <Text className="font-bold">Power Consumption:</Text> {metrics?.powerConsumption ?? 'Loading...'}
            </Text>
            <Text className="text-lg text-[#454545]">
              <Text className="font-bold">Maintenance Alert:</Text> {metrics?.maintenanceAlert ?? 'Loading...'}
            </Text>
          </View>
          <View className="h-[100px] bg-gray-100/20 rounded-md mt-3 flex items-center justify-center">
        ...
        <View className="p-5 bg-white/10 rounded-[10px] shadow-sm">
          ...
          <View className="flex-col gap-2">
            ...
            <Text className="text-lg text-[#454545]">
              <Text className="font-bold">Estimated Revenue:</Text> {metrics?.estimatedRevenue ?? 'Loading...'}
            </Text>
          </View>
          <View className="h-[100px] bg-gray-100/20 rounded-md mt-3 flex items-center justify-center">
        ...
        <View className="p-5 bg-white/10 rounded-[10px] shadow-sm">
          ...
          <View className="flex-col gap-2">
            ...
            <Text className="text-lg text-[#454545]">
              <Text className="font-bold">Energy Consumption:</Text> {metrics?.energyConsumption ?? 'Loading...'}
            </Text>
            <Text className="text-lg text-[#454545]">
        ...
        <View className="p-5 bg-white/10 rounded-[10px] shadow-sm">
          ...
          <View className="flex-col gap-2">
            ...
            <Text className="text-lg text-[#454545]">
              <Text className="font-bold">Gold-to-Currency Ratio:</Text> {metrics?.goldToCurrencyRatio ?? 'Loading...'}
            </Text>
            <Text className="text-lg text-[#454545]">
              <Text className="font-bold">Transaction Volume:</Text> {metrics?.transactionVolume ?? 'Loading...'}
            </Text>
          </View>
          <View className="h-[100px] bg-gray-100/20 rounded-md mt-3 flex items-center justify-center">
